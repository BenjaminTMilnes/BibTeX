...
namespace BibTeX
{
    [BibTeXEntryName("phdthesis")]
    public class BibTeXPhDThesis : BibTeXEntry
    {
        ...
        public BibTeXPhDThesis() { }

        public BibTeXPhDThesis(string author, string title, string school, string year)
        {
            Author = author;
            Title = title;
            School = school;
